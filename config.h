...
/* Color definitions */
static const char normbordercolor[] = "#4c566a"; /* Gray border for unfocused windows */
static const char selbordercolor[]  = "#81a1c1"; /* Blue border for focused windows */
static const char normbgcolor[]     = "#2e3440"; /* Dark background */
static const char normfgcolor[]     = "#d8dee9"; /* Light foreground text */
static const char selbgcolor[]      = "#3b4252"; /* Slightly lighter background for selected elements */
static const char selfgcolor[]      = "#eceff4"; /* Light foreground text for selected elements */
...
/* tagging */
static const char *tags[] = { "1", "2", "󰊖3", "4", "5" };
...
static const char *launchersel[] = { "rofi", "-show", "window", NULL };
static const char *termcmd[]     = { "kitty", NULL };
static const char *launcherfile[]     = { "thunar", NULL };
static Key keys[] = {
    /*ME*/
    { MODKEY,                       XK_Tab,                    spawn,          {.v = launchersel } },
    { MODKEY|ShiftMask,             XK_e,                      spawn,          {.v = launcherfile} },
    /* modifier                     key                        function        argument */
    { MODKEY,                       XK_space,                  spawn,          {.v = launchercmd} },
    { MODKEY|ControlMask,           XK_r,                      spawn,          SHCMD ("protonrestart")},
    { MODKEY,                       XK_x,                      spawn,          {.v = termcmd } },
    { MODKEY,                       XK_b,                      spawn,          SHCMD ("xdg-open https://")},
    { MODKEY,                       XK_p,                      spawn,          SHCMD ("flameshot full -p /home/neeraj/Pictures/screenshots/")},
    { MODKEY|ShiftMask,             XK_p,                      spawn,          SHCMD ("flameshot gui -p /home/neeraj/Pictures/screenshots/")},
